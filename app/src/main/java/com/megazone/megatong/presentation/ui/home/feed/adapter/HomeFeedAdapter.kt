...
import com.megazone.base.ui.activity.BaseActivity.Companion.FONT_TYPE_BOLD
import com.megazone.base.ui.activity.BaseActivity.Companion.FONT_TYPE_MEDIUM
...
import com.megazone.megatong.presentation.ui.home.feed.adapter.snapadapter.PhotoAdapter
...
class HomeFeedAdapter(private val fragment: HomeFeedFragment, private val selector: PressablePlayerSelector)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<Feed> {
        ...
        when(viewType) {
            PHOTO_TYPE -> {
                ...
                holder = HomePhotoFeedHolder(view, this, RecyclerView.RecycledViewPool())
            }

            VIDEO_TYPE -> {
                val view = inflater.inflate(R.layout.list_feed_video_item, parent, false)

                holder = HomeVideoFeedHolder(view, this, selector)
            }

            PLAIN_TYPE -> {
                val view = inflater.inflate(R.layout.list_feed_plain_item, parent, false)

                holder = HomePlainFeedHolder(view, this)
            }
    ...
    class HomePhotoFeedHolder(override val containerView: View, private val adapter: HomeFeedAdapter,
        ...
        private fun setIndicator(containerView: View, maxCount: Int) {
            with(containerView) {
                indicator.setMaxCount(maxCount)
    ...
    class HomePlainFeedHolder(override val containerView: View, private val adapter: HomeFeedAdapter)
                                                : BaseViewHolder<Feed>(containerView), LayoutContainer {
        @SuppressLint("SetTextI18n")
        override fun bindItemHolder(holder: BaseViewHolder<Feed>, item: Feed, position: Int) {
            val activity = adapter.fragment.homeActivity
    ...
    class HomeVideoFeedHolder(override val containerView: View, private val adapter: HomeFeedAdapter,
                              private val selector: PressablePlayerSelector): BaseViewHolder<Feed>(containerView),
                                                                               LayoutContainer, ToroPlayer {
        ...
        override fun bindItemHolder(holder: BaseViewHolder<Feed>, item: Feed, position: Int) {
            ...
            with(containerView) {
                ...
                activity.setUserPic(item.user.photo, iv_video_item_user)
                if (item.user.name == "") {
                ...
                holder.itemView.setOnLongClickListener(selector)
            }
        }

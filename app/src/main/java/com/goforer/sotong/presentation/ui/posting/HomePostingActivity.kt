...
import com.goforer.base.common.utils.CommonUtils.withDelay
...
import com.goforer.sotong.presentation.caller.Caller.EXTRA_FEED_ID
import com.goforer.sotong.presentation.caller.Caller.EXTRA_FEED_POSTING_START_TYPE
import com.goforer.sotong.presentation.caller.Caller.EXTRA_USER_ID
import com.goforer.sotong.presentation.caller.Caller.FEED_POSTING_CREATED_RESULT
import com.goforer.sotong.presentation.caller.Caller.FEED_POSTING_CREATE_REQUEST
import com.goforer.sotong.presentation.caller.Caller.FEED_POSTING_NONE_RESULT
import com.goforer.sotong.presentation.caller.Caller.FEED_POSTING_UPDATED_RESULT
import com.goforer.sotong.presentation.caller.Caller.REQUEST_NONE
import com.goforer.sotong.presentation.ui.home.HomeActivity
import com.goforer.sotong.presentation.ui.posting.glideengine.GlideV4Engine
import com.goforer.sotong.presentation.ui.posting.workmanager.FeedPostingWorker
import com.goforer.sotong.presentation.ui.posting.workmanager.FeedPostingWorker.FeedPostingObject
import com.goforer.sotong.presentation.ui.posting.workmanager.FeedPostingWorker.Companion.FEED_POSTING_WORK
